                ...
                hbox:
                    ...
                    for column_index in range(items_per_column):
                        ...
                        if item_index < items_count:
                            ...
                            $ item_description = get_item_description(active_set, active_tab, item_index)
                            ...
                            frame:
                                ...
                                if active_set == "set1":
                                    background "frame_gallery_default.png"
                                elif active_set == "gallery":
                                    if active_tab == "tab1":
                                        background "frame_gallery_default.png"
                                    ...
                                    if active_tab == "tab1":
                                        background "frame_cg_default1.png"
                                    elif active_tab == "tab2":
                                        background "frame_cg_default1.png"
...
screen item_description_popup(item_click_background, description):
    modal True
    ...
    hbox:
        ...
        vbox:
            ...
            # xsize 500
            # ysize 300
            text description# Display the description here
            #     yalign 1
        imagebutton idle "btn_close_1.png" hover "btn_close_1-1.png"action Hide("item_description_popup"):
                xalign 1
...
screen quick_menu():
    ...
    imagebutton:
        idle "temp/menu_idle.png"  # Replace "your_button_image.png" with your button image path
        hover "temp/menu_hover.png"  # Replace "your_button_image_hover.png" with hover image path
        clicked "temp/menu_hover.png"  # Replace "your_button_image_clicked.png" with clicked image path
        action ShowMenu("quick_menu_options")  # Display the menu options upon clicking

        xalign 1.0  # Align the image button to the right
        yalign 0.0  # Align the image button to the top
    imagebutton:
        idle "temp/folder_idle.png"  
        hover "temp/folder_hover.png"  
        clicked "temp/folder_hover.png"  
        action ShowMenu("inventory")  

        xalign 0.95  # Align the image button to the right
        yalign 0.0  # Align the image button to the top
...
screen quick_menu_options():
    ...
    vbox:
        ...
        imagebutton:
            idle "temp/menu_hover.png"
            hover "temp/menu_hover.png"
            action Return()
            xalign 1.0
        imagebutton:
            idle "temp/btn_inventory.png"
            hover "temp/btn_inventory.png"
            action ShowMenu('inventory')
        imagebutton:
            idle "temp/btn_auto.png"
            hover "temp/btn_auto.png"
            action Preference("auto-forward", "toggle")
        imagebutton:
            idle "temp/btn_save.png"
            hover "temp/btn_save.png"
            action ShowMenu('save')
        imagebutton:
            idle "temp/btn_qsave.png"
            hover "temp/btn_qsave.png"
            action QuickSave()
        imagebutton:
            idle "temp/btn_qload.png"
            hover "temp/btn_qload.png"
            action QuickLoad()
        imagebutton:
            idle "temp/btn_prefs.png"
            hover "temp/btn_prefs.png"
            action ShowMenu('preferences')
        imagebutton:
            idle "temp/btn_back.png"
            hover "temp/btn_back.png"
            action Rollback()       
